...
\033[1;92m\n88888 8888 .d88b 8   8    
  ...
  8   8888 *Y88P 8   8                              
\n\033[0m----------------------------------------------------------------------------------
\033[1;92mAuthor \033[1;93m:MAFIA SHIHAB
\033[1;92mFb \033[1;93m: Md.shihab
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100043148890566')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open https://youtube.com/channel/UCmkL-z_-AXl5WMWeyqXw_lQ')
        main()
    else:
        print ''
